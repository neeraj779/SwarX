import { albumAPIResponseSchema, albumSchema } from '@/modules/album/schemas/album.schema';
import { z } from 'zod';
...
export type ArtistAlbumAPIResponse = z.infer<typeof artistAlbumAPIResponseSchema>;
