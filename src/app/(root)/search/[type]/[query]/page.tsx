...
export default async function SearchPage({ params }: SearchPageProps) {
  ...
  return (
    <div className="mb-4 space-y-4">
      <header>
        <h1 className="font-heading text-center text-2xl capitalize drop-shadow-md sm:text-3xl md:text-start md:text-4xl dark:bg-gradient-to-br dark:from-neutral-200 dark:to-neutral-600 dark:bg-clip-text dark:text-transparent">
          Search Results for{" "}
