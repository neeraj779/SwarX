...
import { getTopSearches } from "@/services/saavnify.service";
...
export async function TopSearch() {
  ...
  return (
    <>
      <p className="font-heading text-xl drop-shadow-md sm:text-2xl md:text-3xl dark:bg-gradient-to-br dark:from-neutral-200 dark:to-neutral-600 dark:bg-clip-text dark:text-transparent">
        Trending Searches
      </p>
